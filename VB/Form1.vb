...
#Region "#LoadISpellDictionaries"
            ...
            Dim ispellDictionaryEnglish As SpellCheckerISpellDictionary = New SpellCheckerISpellDictionary()
...
#End Region  ' #LoadISpellDictionaries
            Dim ispellDictionarySpanish As SpellCheckerISpellDictionary = New SpellCheckerISpellDictionary()
...
#Region "#LoadHunspellDictionaries"
            spellChecker1.Dictionaries.Clear()
            Dim hunspellDictionaryEnglish As HunspellDictionary = New HunspellDictionary()
...
#End Region  ' #LoadHunspellDictionaries
            Dim hunspellDictionarySpanish As HunspellDictionary = New HunspellDictionary()
